...
Full set of changes: [`2.10.4...2.10.6`](https://github.com/AllInOneInstagramBot/bot/compare/2.10.4...2.10.6)
## 2.10.5 (2021-11-18)
...
Full set of changes: [`2.10.4...2.10.5`](https://github.com/AllInOneInstagramBot/bot/compare/2.10.4...2.10.5)
...
Full set of changes: [`2.10.3...2.10.4`](https://github.com/AllInOneInstagramBot/bot/compare/2.10.3...2.10.4)
...
Full set of changes: [`2.10.2...2.10.3`](https://github.com/AllInOneInstagramBot/bot/compare/2.10.2...2.10.3)
...
Full set of changes: [`2.10.1...2.10.2`](https://github.com/AllInOneInstagramBot/bot/compare/2.10.1...2.10.2)
...
Full set of changes: [`2.10.0...2.10.1`](https://github.com/AllInOneInstagramBot/bot/compare/2.10.0...2.10.1)
...
Full set of changes: [`2.9.2...2.10.0`](https://github.com/AllInOneInstagramBot/bot/compare/2.9.2...2.10.0)
...
Full set of changes: [`2.9.1...2.9.2`](https://github.com/AllInOneInstagramBot/bot/compare/2.9.1...2.9.2)
...
Full set of changes: [`2.9.0...2.9.1`](https://github.com/AllInOneInstagramBot/bot/compare/2.9.0...2.9.1)
...
Full set of changes: [`2.8.0...2.9.0`](https://github.com/AllInOneInstagramBot/bot/compare/2.8.0...2.9.0)
...
Full set of changes: [`2.7.7...2.8.0`](https://github.com/AllInOneInstagramBot/bot/compare/2.7.7...2.8.0)

## 2.7.7 (2021-08-03)

#### Fixes

* place first post not found [#208](https://github.com/AllInOneInstagramBot/bot/issues/208)
* replace detect-block with disable-block-detection
#### Performance improvements

* removed unneeded class and sort imports

Full set of changes: [`2.7.6...2.7.7`](https://github.com/AllInOneInstagramBot/bot/compare/2.7.6...2.7.7)
...
Full set of changes: [`2.7.5...2.7.6`](https://github.com/AllInOneInstagramBot/bot/compare/2.7.5...2.7.6)
...
* a better way to sort following list [#207](https://github.com/AllInOneInstagramBot/bot/issues/207)
#### Performance improvements
...
Full set of changes: [`2.7.4...2.7.5`](https://github.com/AllInOneInstagramBot/bot/compare/2.7.4...2.7.5)
...
Full set of changes: [`2.7.3...2.7.4`](https://github.com/AllInOneInstagramBot/bot/compare/2.7.3...2.7.4)
...
Full set of changes: [`2.7.2...2.7.3`](https://github.com/AllInOneInstagramBot/bot/compare/2.7.2...2.7.3)
...
Full set of changes: [`2.7.1...2.7.2`](https://github.com/AllInOneInstagramBot/bot/compare/2.7.1...2.7.2)

## 2.7.1 (2021-07-13)

#### New Features

* you can dump your current screen with that command `AllInOneInstagramBot dump`
#### Performance improvements

* we don't need to click on a obj if we are already on it

Full set of changes: [`2.7.0...2.7.1`](https://github.com/AllInOneInstagramBot/bot/compare/2.7.0...2.7.1)
...
Full set of changes: [`2.6.5...2.7.0`](https://github.com/AllInOneInstagramBot/bot/compare/2.6.5...2.7.0)
...
Full set of changes: [`2.6.4...2.6.5`](https://github.com/AllInOneInstagramBot/bot/compare/2.6.4...2.6.5)
...
Full set of changes: [`2.6.3...2.6.4`](https://github.com/AllInOneInstagramBot/bot/compare/2.6.3...2.6.4)
...
Full set of changes: [`2.6.2...2.6.3`](https://github.com/AllInOneInstagramBot/bot/compare/2.6.2...2.6.3)
...
Full set of changes: [`2.6.1...2.6.2`](https://github.com/AllInOneInstagramBot/bot/compare/2.6.1...2.6.2)
...
Full set of changes: [`2.6.0...2.6.1`](https://github.com/AllInOneInstagramBot/bot/compare/2.6.0...2.6.1)

## 2.6.0 (2021-06-24)

#### New Features

* you can run AllInOneInstagramBot from the command line for initializing your account folder with all the files needed
