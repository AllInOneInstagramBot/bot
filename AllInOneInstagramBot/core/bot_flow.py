...
def start_bot(**kwargs):
    ...
    if not kwargs:
        if "--config" not in configs.args:
            logger.info(
                "It's strongly recommend to use a config.yml file. Follow these links for more details:https://www.allinoneinstagrambot.com/configuration-file#h.tbd3quna55ze",
