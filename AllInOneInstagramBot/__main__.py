    ...
    if args.account_name is not None:
        ...
        for username in args.account_name:
            ...
            if not path.exists(f"./accounts/{username}"):
                print(
                    f"Creating 'accounts/{username}' folder with a config starting point inside. You have to edit these files according withhttps://www.allinoneinstagrambot.com/configuration-file#h.tbd3quna55ze"
                )
                download_from_github(
