<p align="center">
  <img src="https://github.com/AllInOneInstagramBot/bot/raw/master/res/logo.png">
  <br />
  ...
  <p align="center">
    <a href="https://github.com/AllInOneInstagramBot/bot/blob/master/LICENSE">
      <img src="https://img.shields.io/github/license/AllInOneInstagramBot/bot?style=flat" />
    </a>
    <a href="https://www.python.org/">
      <img src="https://img.shields.io/badge/built%20with-Python3-red.svg?style=flat" />
    </a>
    <a href="https://github.com/AllInOneInstagramBot/bot/pulls">
      <img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat" />
    </a>
    <a href="https://github.com/AllInOneInstagramBot/bot/issues">
    	<img src="https://img.shields.io/github/issues/AllInOneInstagramBot/bot?style=flat" />
    </a>
    <a href="https://github.com/AllInOneInstagramBot/bot/pulls">
      <img src="https://img.shields.io/github/issues-pr/AllInOneInstagramBot/bot?style=flat" />
    </a>
    <a href="https://github.com/AllInOneInstagramBot/bot/stargazers">
	    <img src="https://img.shields.io/github/stars/AllInOneInstagramBot/bot?style=flat">
    </a>
    <a href="https://img.shields.io/github/last-commit/AllInOneInstagramBot/bot/master?style=flat">
	    <img src="https://img.shields.io/github/last-commit/AllInOneInstagramBot/bot/master?style=flat">
    </a>
    <a href="https://pypi.org/project/AllInOneInstagramBot/">
      <img src="https://img.shields.io/pypi/dm/AllInOneInstagramBot">
    </a>
    <a href="https://github.com/AllInOneInstagramBot/bot#backers">
	    <img src="https://img.shields.io/opencollective/backers/AllInOneInstagramBot?style=flat">
    </a>  
...
Don't worry about that now, it's not that hard to start botting with AllInOneInstagramBot! I tried to make it as noob-friendly as possible. In any case, if you follow the docs with all the steps provided, you will make it! You are also invited to join our community and ask for any help!
...
<p align="center">
  <img src="https://github.com/AllInOneInstagramBot/bot/raw/master/res/demo.gif">
</p>
...
Yes, but you can also run it [directly on your phone](https://docs.AllInOneInstagramBot.org/#/termux)!!
...
- Comment post with emojis and [spintax logic](https://github.com/AllInOneInstagramBot/docs/blob/main/configuration.md#spintax-support)
- Send PM
...
Full documentation available on [docs.AllInOneInstagramBot.org](https://docs.AllInOneInstagramBot.org)

## Telegram reports? What's that?
You can get __reports__ through telegram from your bot activities!
[Follow this guide to accomplish that](https://docs.AllInOneInstagramBot.org/#/configuration?id=telegram-reports).

<img src="https://github.com/AllInOneInstagramBot/bot/raw/master/res/telegram-reports.png" width="200">
...
I'll try to help you accomplish that with a short tutorial. The full is available [here](https://docs.AllInOneInstagramBot.org/#/quickstart).
...
Failed? [Detailed tutorial here](https://docs.AllInOneInstagramBot.org/#/quickstart?id=step-1-install-python-if-not-installed).
...
### Step 2: Install AllInOneInstagramBot:
You can install AllInOneInstagramBot in two ways: with __pip__ or with __git__.
...
- install the package: `pip3 install AllInOneInstagramBot`
- check if it's installed: `AllInOneInstagramBot --version`
- if everything is fine you will get the AllInOneInstagramBot version installed 🥳

#### With git:
> __Warning:__ console commands like `AllInOneInstagramBot init`, `AllInOneInstagramBot dump` and `AllInOneInstagramBot run` won't work if you installed the bot with git.
- clone the project: `git clone https://github.com/AllInOneInstagramBot/bot.git AllInOneInstagramBot`
- enter the AllInOneInstagramBot folder: `cd AllInOneInstagramBot`
...
6. initialize AllInOneInstagramBot: `AllInOneInstagramBot init your_ig_account_name_here`
        ...
        AllInOneInstagramBot/
          ...
          accounts/
            youraccountname/
              ...
              pm_list.txt
      ```
7. now that you have all the requirements you have to configure the whole thing by [following this guide](https://docs.AllInOneInstagramBot.org/#/configuration)
8. now you're done and you can finally start the bot: `python3 run.py --config accounts/yourusername/config.yml` or `AllInOneInstagramBot run --config accounts/yourusername/config.yml`

Failed? [Check this out!](https://docs.AllInOneInstagramBot.org/#/quickstart?id=troubleshooting)
...
This project exists thanks to all of our Contributors [[Contribute](https://docs.AllInOneInstagramBot.org/#/contributing)].

<a href="https://github.com/AllInOneInstagramBot/bot/graphs/contributors"><img src="https://opencollective.com/AllInOneInstagramBot/contributors.svg?width=890&button=false" /></a>

<br />

# Backers

Thank you to everyone that supports us financially! 🙏 [[Become a backer](https://opencollective.com/AllInOneInstagramBot#backer)]

<a href="https://opencollective.com/AllInOneInstagramBot#backers" target="_blank"><img src="https://opencollective.com/AllInOneInstagramBot/backers.svg?width=890"></a>
<br />
...
<p>
  <a href="https://discord.gg/NK8PNEFGFF">
    <img hspace="3" alt="Join us on Discord" src="https://github.com/AllInOneInstagramBot/bot/raw/master/res/discord.png" height=84/>
  </a>
</p>
